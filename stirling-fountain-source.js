/* =============================================================================
   ...
   DEPLOYMENT NOTES
   - This zip also carries ready-to-deploy copies: index.html (site with CSS+JS
     inlined — double-click to run or deploy as-is) and admin.html (the flavor
     board admin). Push both to the repo root and Vercel serves them with zero
     build settings; the footer "Admin Panel" button links index → admin.
   ...
   - The default board seeded in the backend is the shop's current 33-flavor
     Hard Scoop case plus Soft Serve and Ices & Lighter.
...
<body>
  ...
  <main>
    ...
    <section class="section section-dark" id="flavors">
      <div class="section-inner">
        <div class="section-head reveal">
          <p class="kicker kicker-light">Forty ways to say yes</p>
        ...
        <div class="panel is-active" id="panel-scoop" role="tabpanel" aria-labelledby="tab-scoop">
          <ul class="flavors">
            <li style="--dot:#F49FB6">Cotton Confetti</li>
            <li style="--dot:#6B4226">Chocolate</li>
            <li style="--dot:#ED7285">Strawberry</li>
            <li style="--dot:#F6EBD8">Vanilla</li>
            <li style="--dot:#F2D25C">Lemon Bar</li>
            <li style="--dot:#7FCFA4">Cool Mint Cookie</li>
            <li style="--dot:#4C2E1D">Death by Chocolate</li>
            <li style="--dot:#C2426E">Amaretto Cherry</li>
            <li style="--dot:#C98A3B">Peanut Butter Brownie</li>
            <li style="--dot:#F5D848">Play Dough</li>
            <li style="--dot:#B77A46">Campfire S'mores</li>
            <li style="--dot:#8FA6D9">Blueberry Cheesecake</li>
            <li style="--dot:#D99A4E">Sea Salt Caramel Nut</li>
            <li style="--dot:#B57F4A">Sea Salt Caramel Cold Brew</li>
            <li style="--dot:#8A5A3B">Camp Coffee</li>
            <li style="--dot:#D8D3CC">Cookies and Cream</li>
            <li style="--dot:#E4C48F">Cookie Dough</li>
            <li style="--dot:#9ADBB8">Mint Chocolate Chip</li>
            <li style="--dot:#F5A05A">Rainbow Sherbet</li>
            <li style="--dot:#D98CA6">Rich and Famous</li>
            <li style="--dot:#F4EFE6">Coconut Castaway</li>
            <li style="--dot:#A64D8C">Black Raspberry Chip</li>
            <li style="--dot:#E0566B">White Chocolate Raspberry</li>
            <li style="--dot:#DDA758">Dulce De Leche</li>
            <li style="--dot:#E0788C">Cherry Vanilla</li>
            <li style="--dot:#8E3B3B">Pirates Treasure</li>
            <li style="--dot:#F2D291">Tipsy Banana</li>
            <li style="--dot:#7EC8E3">Hook Line and Sinker</li>
            <li style="--dot:#F3C7E0">Cake Pop</li>
            <li style="--dot:#C77E3E">Tennessee Toffee</li>
            <li style="--dot:#66BFAE">Sea Turtle</li>
            <li style="--dot:#D9913F">Cow Creek</li>
            <li style="--dot:#8A5A38">Brownie Bake</li>
          </ul>
        </div>
...
.admin-link {
  ...
  margin-top: 18px;
  padding: 8px 20px;
  border: 1.5px solid rgba(255, 247, 234, 0.25);
  border-radius: 999px;
  font-size: 12px;
  font-weight: 700;
...
.admin-link:hover { color: var(--cream); border-color: rgba(255, 247, 234, 0.6); transform: translateY(-1px); }
