/* =============================================================================
   ...
   Files included:
     1. index.html — the public site (self-contained: all CSS + JS inline).
                     Uses the img/ folder for the shop + creamery logos.
     2. admin.html — password-gated Flavor Board admin panel (standalone page).

   IMAGE ASSETS (in the img/ folder, referenced by index.html):
     - img/stirling-logo.png — The Stirling Fountain gold logo (hero)
     - img/ashbys.webp       — Ashby's Sterling Ice Cream logo
     - img/giffords.png      — Gifford's Famous Ice Cream logo

   DEPLOYMENT NOTES
   - Deploy index.html + admin.html + the img/ folder together at the site root.
     Vercel / GitHub Pages / any static host works with zero build settings; the
     footer "Admin" button links index → admin.
   - The flavor board (names, colors, tags AND descriptions) is loaded at runtime
     from the TouchBridge backend and works from ANY domain:
     ...
     Saves persist in durable storage — every visitor sees the saved board on
     the next page load. If the network is unreachable, index.html falls back
     to the built-in default board embedded in its script.
   ============================================================================= */
...
<body>
  ...
  <main>
    ...
    <section class="hero">
      ...
      <div class="hero-inner">
        ...
        <img class="hero-logo sf-pop" src="img/stirling-logo.png" alt="The Stirling Fountain" />
        <p class="hero-lede">
      ...
      <div class="container center">
        ...
        <div class="brand-grid">
          <div class="brand-card card-lift" style="text-align:left">
            <span class="logo-box"><img src="img/ashbys.webp" alt="Ashby's Sterling Ice Cream logo" loading="lazy" /></span>
            <div>
          ...
          <div class="brand-card card-lift" style="text-align:left">
            <span class="logo-box"><img src="img/giffords.png" alt="Gifford's Famous Ice Cream logo" loading="lazy" /></span>
            <div>
  ...
  (function () {
    ...
    /* ------------------------------------------------ hours */
    /* [openMinutes, closeMinutes] per JS day (0 = Sunday). */
    var HOURS = [
      [13 * 60, 21 * 60],
      [15 * 60, 21 * 60],
      [15 * 60, 21 * 60],
    ...
    if (dayList) {
      for (var d2 = 0; d2 < 7; d2++) {
        ...
        timeEl.textContent = fmtTime(HOURS[d2][0]) + " – " + fmtTime(HOURS[d2][1]);
      ...
      function render() {
        ...
        board.categories.forEach(function (cat, ci) {
          ...
          add.addEventListener("click", function () {
            cat.flavors.push({ name: "", dot: "#F6BFCB", small: "", desc: "" });
            render();
            queueSave();
